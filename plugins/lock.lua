...
pm = pm..'\n\n🔹 Lock Links : '..group[tostring(target)]['settings']['lock_link']..' '
pm = pm..'\n🔹 Lock Username : '..(group[tostring(target)]['settings']['lock_username'] or 'no')..' '
pm = pm..'\n🔹 Lock Tag : '..(group[tostring(target)]['settings']['lock_tag'] or 'no')..' '
pm = pm..'\n🔹 Lock Edit : '..group[tostring(target)]['settings']['lock_edit']..' '
pm = pm..'\n🔹 Lock Fwd : '..(group[tostring(target)]['settings']['lock_fwd'] or 'no')..' '
pm = pm..'\n🔹 Lock tgservice : '..(group[tostring(target)]['settings']['lock_tgservice'] or 'no')..' '
pm = pm..'\n🔹 Lock Spam : '..(group[tostring(target)]['settings']['lock_spam'] or 'no')..' '
pm = pm..'\n🔹 Lock English : '..(group[tostring(target)]['settings']['lock_english'] or 'no')..' '
pm = pm..'\n🔹 Lock Arabic : '..(group[tostring(target)]['settings']['lock_persian'] or 'no')..' '
--pm = pm..'\n     🔧<b>Mute</b>🔧'
pm = pm..'\n🔹 Lock All : '..(group[tostring(target)]['settings']['mute_all'] or 'no')..' '
pm = pm..'\n🔹 Lock Photo : '..(group[tostring(target)]['settings']['mute_photo'] or 'no')..' '
pm = pm..'\n🔹 Lock Video : '..(group[tostring(target)]['settings']['mute_video'] or 'no')..' '
pm = pm..'\n🔹 Lock Voice : '..(group[tostring(target)]['settings']['mute_voice'] or 'no')..' '
pm = pm..'\n🔹 Lock Document : '..(group[tostring(target)]['settings']['mute_document'] or 'no')..' '
pm = pm..'\n🔹 Lock Audio : '..(group[tostring(target)]['settings']['mute_audio'] or 'no')..' '
pm = pm..'\n🔹 Lock Gif : '..(group[tostring(target)]['settings']['mute_gif'] or 'no')..' '
...
pm = '🔧SuperGroup settings 🔧'
pm = pm..'\n\n🔹 Lock Links : '..group[tostring(target)]['settings']['lock_link']..' '
pm = pm..'\n🔹 Lock Username : '..group[tostring(target)]['settings']['lock_username']..' '
pm = pm..'\n🔹 Lock Tag : '..group[tostring(target)]['settings']['lock_tag']..' '
pm = pm..'\n🔹 Lock Edit : '..group[tostring(target)]['settings']['lock_edit']..' '
pm = pm..'\n🔹 Lock Fwd : '..group[tostring(target)]['settings']['lock_fwd']..' '
pm = pm..'\n🔹 Lock Tgservice : '..group[tostring(target)]['settings']['lock_tgservice']..' '
pm = pm..'\n🔹 Lock Spam : '..group[tostring(target)]['settings']['lock_spam']..' '
pm = pm..'\n🔹 Lock English : '..group[tostring(target)]['settings']['lock_english']..' '
pm = pm..'\n🔹 Lock Arabic : '..group[tostring(target)]['settings']['lock_persian']..' '
--pm = pm..'\n     🔧<b>Mute</b>🔧'
pm = pm..'\n🔹 Lock All : '..group[tostring(target)]['settings']['mute_all']..''
pm = pm..'\n🔹 Lock Photo : '..group[tostring(target)]['settings']['mute_photo']..' '
pm = pm..'\n🔹 Lock Video : '..group[tostring(target)]['settings']['mute_video']..' '
pm = pm..'\n🔹 Lock Voice : '..group[tostring(target)]['settings']['mute_voice']..' '
pm = pm..'\n🔹 Lock Document : '..group[tostring(target)]['settings']['mute_document']..' '
pm = pm..'\n🔹 Lock Audio : '..group[tostring(target)]['settings']['mute_audio']..' '
pm = pm..'\n🔹 Lock Gif : '..group[tostring(target)]['settings']['mute_gif']..' '
pm = pm..'\n 🔅🔅🔅🔅🔅🔅🔅 \n ♨ <b>Channel: </b>@LeaderCh ♨ '
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
end
